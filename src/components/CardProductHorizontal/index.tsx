...
const CardProductHorizontal = (props: Props) => {
    ...
    return (
        <div className='grid grid-cols-[100px_1fr] gap-[12px]'>
            <img loading='lazy' src='https://hoaphatthietbi.com/wp-content/uploads/2024/11/may-nghien-be-tong26-300x300.jpg' alt='product' width={size} height={size} className='cursor-pointer' />
            <div >
